/**
*   @file    hse_host_services.h
*
*   @brief   Global includes for HSE host services header files
*/
/*==================================================================================================
...
#ifndef _HSE_HOST_SERVICES_H_
#define _HSE_HOST_SERVICES_H_
